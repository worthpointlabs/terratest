...
title: Terraform Backend example test
category: tests
excerpt: >-
...
Full source code can be found here: [terraform_backend_example_test.go](https://github.com/gruntwork-io/terratest/blob/master/test/terraform_backend_example_test.go).

Check out the corresponding example: [Terraform Backend Example]({{site.baseurl}}/examples/code-examples/terraform-backend-example/).
