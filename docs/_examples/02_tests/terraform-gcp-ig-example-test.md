...
title: Terraform GCP Managed Instance Group Example Test
category: tests
excerpt: >-
...
Full source code can be found here: [terraform_gcp_ig_example_test.go](https://github.com/gruntwork-io/terratest/blob/master/test/terraform_gcp_ig_example_test.go).

Check out the corresponding example: [Terraform GCP Managed Instance Group Example]({{site.baseurl}}/examples/code-examples/terraform-gcp-ig-example/).
