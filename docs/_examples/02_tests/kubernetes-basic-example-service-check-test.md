...
title: Kubernetes basic example - service check test
category: tests
excerpt: >-
  Test for a more advanced version of checking the service.
tags: ["example"]
...
Full source code can be found here: [kubernetes_basic_example_service_check_test.go](https://github.com/gruntwork-io/terratest/blob/master/test/kubernetes_basic_example_service_check_test.go).

Check out the corresponding example: [Kubernetes Basic Example]({{site.baseurl}}/examples/code-examples/kubernetes-basic-example/).
