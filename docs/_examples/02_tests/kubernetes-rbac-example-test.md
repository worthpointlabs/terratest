...
Full source code can be found here: [kubernetes_rbac_example_test.go](https://github.com/gruntwork-io/terratest/blob/master/test/kubernetes_rbac_example_test.go).

Check out the corresponding example: [Kubernetes RBAC Example]({{site.baseurl}}/examples/code-examples/kubernetes-rbac-example/).
