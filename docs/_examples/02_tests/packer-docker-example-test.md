...
category: tests
excerpt: >-
  An example of how to test the Packer template in packer-docker-example completely locally using Terratest and Docker.
tags: ["example", "packer", "docker"]
...
Full source code can be found here: [packer_docker_example_test.go](https://github.com/gruntwork-io/terratest/blob/master/test/packer_docker_example_test.go).

Check out the corresponding example: [Packer Docker Example]({{site.baseurl}}/examples/code-examples/packer-docker-example/).
