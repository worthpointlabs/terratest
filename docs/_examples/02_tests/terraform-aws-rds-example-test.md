...
title: Terraform AWS RDS example test
category: tests
excerpt: >-
...
Full source code can be found here: [terraform_aws_rds_example_test.go](https://github.com/gruntwork-io/terratest/blob/master/test/terraform_aws_rds_example_test.go).

Check out the corresponding example: [Terraform AWS RDS Example]({{site.baseurl}}/examples/code-examples/terraform-aws-rds-example/).
