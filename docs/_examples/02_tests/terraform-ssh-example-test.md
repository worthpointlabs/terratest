...
title: Terraform SSH Example Test
category: tests
excerpt: >-
...
Full source code can be found here: [terraform_ssh_example_test.go](https://github.com/gruntwork-io/terratest/blob/master/test/terraform_ssh_example_test.go).

Check out the corresponding example: [Terraform SSH Example]({{site.baseurl}}/examples/code-examples/terraform-ssh-example/).
