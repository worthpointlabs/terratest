...
title: Terraform GCP Example test
category: tests
excerpt: >-
  Use Terratest to run terraform apply on the Terraform GCP Example and verify you get the expected outputs.
tags: ["example"]
...
Full source code can be found here: [terraform_gcp_example_test.go](https://github.com/gruntwork-io/terratest/blob/master/test/terraform_gcp_example_test.go).

Check out the corresponding example: [Terraform GCP Example]({{site.baseurl}}/examples/code-examples/terraform-gcp-example/).
