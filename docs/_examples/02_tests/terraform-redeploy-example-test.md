...
title: Terraform Redeploy Example Test
category: tests
excerpt: >-
...
Full source code can be found here: [terraform_redeploy_example_test.go](https://github.com/gruntwork-io/terratest/blob/master/test/terraform_redeploy_example_test.go).

Check out the corresponding example: [Terraform Redeploy Example]({{site.baseurl}}/examples/code-examples/terraform-redeploy-example/).
