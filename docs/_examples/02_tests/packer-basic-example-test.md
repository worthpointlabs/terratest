...
title: Packer basic example test
category: tests
excerpt: >-
  Use Terratest to run packer build to build an AMI and then use the AWS APIs to delete that AMI.
tags: ["example"]
...
Full source code can be found here: [packer_basic_example_test.go](https://github.com/gruntwork-io/terratest/blob/master/test/packer_basic_example_test.go).

Check out the corresponding example: [Packer Basic Example]({{site.baseurl}}/examples/code-examples/packer-basic-example/).
