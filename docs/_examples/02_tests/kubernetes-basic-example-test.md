...
title: Kubernetes basic example test
category: tests
excerpt: >-
  Test for the most basic verification.
tags: ["example"]
...
Full source code can be found here: [kubernetes_basic_example_test.go](https://github.com/gruntwork-io/terratest/blob/master/test/kubernetes_basic_example_test.go).
