...
title: Terraform AWS S3 example test
category: tests
excerpt: >-
...
Full source code can be found here: [terraform_aws_s3_example_test.go](https://github.com/gruntwork-io/terratest/blob/master/test/terraform_aws_s3_example_test.go).

Check out the corresponding example: [Terraform AWS S3 Example]({{site.baseurl}}/examples/code-examples/terraform-aws-s3-example/).
