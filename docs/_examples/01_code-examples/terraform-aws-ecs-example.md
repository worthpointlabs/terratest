...
title: Terraform AWS ECS Example
category: code-examples
excerpt: >-
  A simple Terraform module that deploys a simple ECS service in AWS.
...
Check out [terraform_aws_ecs_example_test.go]({{ site.baseurl }}/examples/tests/terraform-aws-ecs-example-test/) to see how you can write
