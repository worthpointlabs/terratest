...
title: Terraform GCP Managed Instance Group Example
category: code-examples
excerpt: >-
  A simple Terraform configuration that deploys an Instance Group in GCP.
tags: ["terraform", "gcp", "example"]
...
Check out [terraform_gcp_ig_example_test.go]({{site.baseurl}}/examples/tests/terraform-gcp-ig-example-test/) to see how you can write
