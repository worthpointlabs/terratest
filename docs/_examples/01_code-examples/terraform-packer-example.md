...
title: Terraform Packer Example
category: code-examples
excerpt: >-
  A more complicated example that shows how to use Packer to build an AMI with a web server installed and deploy that AMI in AWS using Terraform.
tags: ["terraform", "packer", "example"]
...
[packer-docker-example]({{site.baseurl}}/examples/code-examples/packer-docker-example/), which contains a simple Ruby web app. This module will
...
Check out [terraform_packer_example_test.go]({{site.baseurl}}/examples/tests/terraform-packer-example-test/) to see how you can write
...
1. Follow the instructions in [packer-docker-example]({{site.baseurl}}/examples/code-examples/packer-docker-example/) to build an AMI. Note down the AMI ID.
