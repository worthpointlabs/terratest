...
title: Terraform Redeploy Example
category: code-examples
excerpt: >-
  This module deploys an Auto Scaling Group (ASG) in the AWS region specified in the aws_region variable and a Load Balancer to route traffic across the ASG.
tags: ["terraform", "aws", "example"]
...
Check out [terraform_redeploy_example_test.go]({{site.baseurl}}/examples/tests/terraform-redeploy-example-test/) to see how you can write
...
example of a Terraform module and web server, see [terraform-packer-example]({{site.baseurl}}/examples/code-examples/terraform-packer-example/).
