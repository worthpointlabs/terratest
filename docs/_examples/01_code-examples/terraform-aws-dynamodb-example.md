...
title: Terraform AWS DynamoDB Example
category: code-examples
excerpt: >-
  A simple Terraform module that deploys a DynamoDB table with server-side encryption, point in time recovery and a TTL (time to live) attribute.
...
Check out [terraform_aws_dynamodb_example_test.go]({{ site.baseurl }}/examples/tests/terraform-aws-dynamodb-example-test/) to see how you can
