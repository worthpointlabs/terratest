...
title: Terraform AWS Network Example
category: code-examples
excerpt: >-
  A Terraform module that deploys a simple network setup to demonstrate how you can use Terratest to write automated tests for your AWS Terraform code. This module deploys two subnets (public and private) within one availability zone.
...
Check out [terraform_aws_network_example_test.go]({{ site.baseurl }}/examples/tests/terraform-aws-network-example-test/) to see how you can write automated tests for this module and verify the basic parameters of the VPC and subnets.
