...
title: Terraform AWS RDS Example
category: code-examples
excerpt: >-
  A simple Terraform module that deploys a database instance (MySQL by default) in AWS.
...
Check out [terraform_aws_rds_example_test.go]({{ site.baseurl }}/examples/tests/terraform-aws-rds-example-test/) to see how you can write
