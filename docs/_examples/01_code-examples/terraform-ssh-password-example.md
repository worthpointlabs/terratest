...
title: Terraform SSH Password Example
category: code-examples
excerpt: >-
  The EC2 Instance allows SSH requests on the port specified by the ssh_port variable, and is configured with a user data script so that it will accept passwords for authentication.
tags: ["terraform", "aws", "ssh", "example"]
...
[the example directory for this test]({{site.baseurl}}/examples/code-examples/terraform-ssh-password-example/) will expect a default VPC to exist in
...
Check out [terraform_ssh_password_example_test.go]({{site.baseurl}}/examples/tests/terraform-ssh-password-example-test/) to see how you
...
[terraform-packer-example]({{site.baseurl}}/examples/code-examples/terraform-packer-example/).
