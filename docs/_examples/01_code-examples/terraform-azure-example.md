...
title: Terraform Azure Example
category: code-examples
excerpt: >-
  A simple Terraform module that deploys a Virtual Machine in Azure and gives that VM a Name tag with the value specified in the vm_name variable.
tags: ["azure", "terraform", "example"]
...
Check out [terraform_azure_example_test.go]({{ site.baseurl }}/examples/tests/terraform-azure-example-test/) to see how you can write
...
[terraform-http-example]({{ site.baseurl }}/examples/code-examples/terraform-http-example) and [terraform-ssh-example]({{ site.baseurl }}/examples/code-examples/terraform-ssh-example).
