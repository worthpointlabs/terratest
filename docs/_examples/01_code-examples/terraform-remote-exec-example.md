...
title: Terraform remote-exec example
category: code-examples
excerpt: >-
  A terraform configuration that creates and AWS instance and then uses remote-exec to provision it.
tags: ["terraform", "remote-exec", "example"]
