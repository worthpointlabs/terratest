...
title: Terraform GCP Example
category: code-examples
excerpt: >-
  AA simple Terraform configuration that creates a GCP Compute Instance and Storage Bucket.
...
Check out [terraform_gcp_example_test.go]({{ site.baseurl }}/examples/tests/terraform-gcp-example-test/) to see how you can write
