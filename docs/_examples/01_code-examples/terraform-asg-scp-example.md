...
title: Terraform ASG SCP Example
category: code-examples
excerpt: >-
  A simple Terraform module that deploys resources in AWS to demonstrate how you can use Terratest to write automated tests for your AWS Terraform code.
...
A simple Terraform module that deploys resources in [AWS](https://aws.amazon.com/) to demonstrate
...
Check out [test/terraform_scp_example_test.go]({{site.baseurl}}/examples/tests/terraform-scp-example-test/) to see how you can write
