...
title: Packer Basic Example
category: code-examples
excerpt: >-
  A simple Packer template for building an Amazon Machine Image (AMI) or Google Cloud Platform Compute Image.
tags: ["packer", "gcp", "example"]
...
Check out [packer_basic_example_test.go]({{ site.baseurl }}/examples/tests/packer-basic-example-test/) to see how you can write
...
[packer-docker-example]({{ site.baseurl }}/examples/code-examples/packer-docker-example) and
