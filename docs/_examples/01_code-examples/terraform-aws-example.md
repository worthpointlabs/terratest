...
excerpt: >-
  A simple Terraform module that deploys resources in AWS. This module deploys an EC2 Instance and gives that Instance a Name tag with the value specified in the instance_name variable.
...
Check out [terraform_aws_example_test.go]({{ site.baseurl }}/examples/tests/terraform-aws-example-test/) to see how you can write
