...
title: Packer Docker Example
category: code-examples
excerpt: >-
  A Packer template that creates an Ubuntu AMI with a simple web app. This template also creates a Docker image with the same web app installed.
tags: ["packer", "docker", "example"]
...
Check out [packer_docker_example_test.go]({{ site.baseurl }}/examples/tests/packer-docker-example-test/) to see how you can write
...
See [terraform-packer-example]({{site.baseurl}}/examples/code-examples/terraform-packer-example/).
