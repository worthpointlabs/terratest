...
This folder contains a Terraform module that deploys a mysql database in [Azure](https://azure.microsoft.com/) to demonstrate how you can use Terratest to write automated tests for your Azure Terraform code. 

This module deploys an [Azure MySQL Database](https://azure.microsoft.com/en-us/services/mysql/).
...
$ export TF_VAR_client_secret={YOUR_SERVICE_PRINCIPAL_PASSWORD}
$ cd test
$ go test -v -timeout 60m -tags azure -run TestTerraformAzureMySQLDBExample
```