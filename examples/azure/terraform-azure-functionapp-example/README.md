...
This folder contains a Terraform module that deploys a basic Function App in [Azure](https://azure.microsoft.com/) to demonstrate how you can use Terratest to write automated tests for your Azure Terraform code.
...
1. Watch the resource group to to the Function App is created.
...
$ terraform init
$ terraform apply
// Open browser and access the Function App by its FQDN
$ terraform destroy
```
...
1. `cd test`
1. `go test -v -timeout 60m -tags azure -run TestTerraformAzureFunctionAppExample`
...
$ export TF_VAR_client_secret={YOUR_SERVICE_PRINCIPAL_PASSWORD}
$ cd test
$ go test -v -timeout 60m -tags azure -run TestTerraformAzureFunctionAppExample
```
