...
`tag_bucket_name` and `tag_bucket_environment` variables, respectively.  This module also contains a variable flag to 
restrict access to the S3 Bucket to SSL connetions only via bucket policy (which is a common enterprise pattern).
